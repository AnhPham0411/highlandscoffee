...
module.exports = function (app) {
  ...
  app.route("/vouchers").get(VoucherController.getVouchers)
  app.route("/addVoucher").post(VoucherController.addVoucher)
  app.route("/updateVoucher/:id").post(VoucherController.updateVoucher)
  app.route("/deleteVoucher/:id").delete(VoucherController.deleteVoucher)


  app.route("/shippings").get(ShippingController.getShippings)
